...
public class BarGraph {
    ...
    public static class DrawBars extends JPanel implements MouseListener {
        ...
        public DrawBars(Dimension dimension) {
            ...
            SimpleCSVReader file = new SimpleCSVReader("projeto_test/demo/csv/mergeSort.csv");
...
public void paintComponent(Graphics g) {
    ...
    for (int i = 0; i <= d.height; i += 100) {  // Aumenta os ticks com a nova altura
        g2.drawLine(50, d.height - i, d.width, d.height - i);  // Linhas horizontais ajustadas
        g2.drawString(Integer.toString(i), 10, d.height - i);  // Valores ajustados
    }

    // Rótulo do eixo X
    g2.setFont(new Font("Arial", Font.PLAIN, 14));
    g2.drawString("Tamanho do Array", d.width / 2 - 50, d.height - 20);  // Centralizado
